...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Train CNN-ConvLSTM dose prediction model')
    parser.add_argument('--data-dir', required=True,
                        help='Directory containing ct_dataset.h5, proj_dataset.h5, dose_dataset.h5')
    parser.add_argument('--out-dir', default=None,
                        help='Output directory (default: ./results/<timestamp>_ConvLSTM)')
    ...
    experiment_dir = args.out_dir or os.path.join('results', f'{current_time}_ConvLSTM')
